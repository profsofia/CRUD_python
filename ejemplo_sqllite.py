# sirve para manejar los datos nulos en la base de datos
from asyncio.windows_events import NULL
import sqlite3 as sq3


con = sq3.connect('mibd.db') # crea la conexión
cur = con.cursor() # El cursor es un carrito que lleva las instrucciones y trae las respuestas
...
# cuando es un campo autoincremental como el id, en sqlite3 hay que ponerle un guión bajo.
...
# el signo de pregunta se usa como comodín
